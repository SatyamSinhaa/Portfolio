		...
		<div className='bg-slate-900 p-4' style={{ cursor: 'default' }}>
			<div className='flex justify-between flex-wrap gap-4'>
				...
				<div className='text-white flex justify-around sm:w-[250px] w-full'>
					...
					<a href="https://leetcode.com/u/satyamsinha72/" target='_blank' className='transition ease-in-out duration-300 rounded-md hover:scale-110 cursor-pointer hover:-translate-y-1' style={{ cursor: 'pointer' }}>
